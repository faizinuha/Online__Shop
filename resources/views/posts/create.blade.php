                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        ...
                        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">Nama Publish</label>
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                    name="title" value="{{ old('title') }}" placeholder="Masukkan Nama Publis:"
                                    @required(true)>
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">Tetang Buku ini:</label>
                                <textarea class="form-control @error('content') is-invalid @enderror" name="content" rows="5"
                                    placeholder="Masukkan Tentang Buku Ini">{{ old('content') }}</textarea>
